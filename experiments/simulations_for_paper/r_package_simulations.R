...
# box plots to show variation in replicates by method
# fix implementation of gamma
# lines to represent studies, by color
# 
...
# new graph, line of best fit from limetr
# points colored by study
# different point type for outliers
